...
if st.session_state.active_step == "Home":
    ...
    if not st.session_state.analysis_complete:
        ...
        st.markdown("The tool will now train a specialized AI model for each significant historical transition.")
    ...
    if not st.session_state.training_complete:
        ...
        st.markdown("This final step uses a Cellular Automata to allocate the projected change across the landscape.")
